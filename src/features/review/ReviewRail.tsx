import { CollapseToggle } from '@/shared/ui/atoms'
				...
				<>
					<div className="review-rail__summary">
						...
						<p>
							...
							<span className="del">−{totals.deletions}</span> in
							the working tree
						</p>
						{tailLine !== undefined && (
				    ...
				    parsed into conversation turns) — every bubble is ours. */}
						{thread.length === 0 ? (
							<p className="review-rail__hint">
								Review is a conversation — ask the agent to
								iterate.
							</p>
						) : (
							<ul>
